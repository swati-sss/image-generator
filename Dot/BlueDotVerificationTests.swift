...
struct FeatureFlagsView: View {
    ...
    enum FlagSection: String {
        ...
        case consumerConfig = "Consumer Config"
    ...
    private func loadFlags() {
        ...
        let consumerConfig = config["consumerConfig"] as? [String: Any] ?? [:]
        let debugLogConfig = config["debugLog"] as? [String: Any] ?? [:]
        ...
        flags = [
            ...
            Flag(name: "Heart Beat In Location", key: "heartbeatInLocation",
                 ...
                 type: .boolean, section: .generalBoolean, parentKey: nil),
            Flag(name: "Heart Beat Enabled", key: "heartbeatEnabled",
                 value: boolValue(config["heartbeatEnabled"]),
                 type: .boolean, section: .generalBoolean, parentKey: nil),
            ...
            Flag(name: "Map CDN Enabled", key: "isMapCdnEnabled",
                 value: boolValue(consumerConfig["isMapCdnEnabled"]),
                 type: .boolean, section: .consumerConfig, parentKey: "consumerConfig"),
            Flag(name: "Map Compression Enabled", key: "isMapCompressionEnabled",
                 value: boolValue(consumerConfig["isMapCompressionEnabled"]),
                 type: .boolean, section: .consumerConfig, parentKey: "consumerConfig"),

            Flag(name: "Sensitive Info Enabled", key: "sensitiveInfoEnabled",
                 value: boolValue(debugLogConfig["sensitiveInfoEnabled"]),
                 type: .boolean, section: .debugLog, parentKey: "debugLog"),
            Flag(name: "Navigation Validate Coord Enabled", key: "navigationValidateCoordEnabled",
                 value: boolValue(debugLogConfig["navigationValidateCoordEnabled"]),
                 type: .boolean, section: .debugLog, parentKey: "debugLog"),

            Flag(name: "Feature Pin Enabled", key: "featurePinEnabled",
                 value: boolValue(pinsConfig["featurePinEnabled"]),
                 type: .boolean, section: .pins, parentKey: "pins"),
            Flag(name: "Feature Pin Type", key: "pinType",
                 value: stringValue(pinsConfig["pinType"]),
                 type: .string, section: .pins, parentKey: "pins"),
...
struct InputSheet: View {
    ...
    private var usesTextEditor: Bool {
        flag.type == .string
    }

    private var editorHeight: CGFloat {
        flag.key == "supportedEventList" ? 320 : 180
    }
            ...
            VStack(spacing: 20) {
                ...
                if usesTextEditor {
                    TextEditor(text: $inputText)
                        .font(.system(.body, design: flag.key == "supportedEventList" ? .monospaced : .default))
