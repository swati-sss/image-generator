  ...
  return (
    <section className='max-w-7xl mx-auto'>
     ...
     <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Create a collection of imaginative visually stunning images generated by Dall-E and share them with the community</p>
